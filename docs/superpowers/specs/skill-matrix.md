...
| Read .tex / .sty / YAML files | `filesystem MCP` | All |
...
| Resume tailoring guardrails | CLAUDE.md rules: no fabrication, never modify .sty, only rephrase/highlight/reorder existing content | 1 |
